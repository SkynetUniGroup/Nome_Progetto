...
def test_parse_output_numbers_findings_in_order():
    """I riscontri conservano l'ordine di arrivo tramite il campo order."""
    raw = _owasp_output([
        {'severity': 'LOW', 'category': 'Primo'},
    ...
    assert [b.category for b in blocks] == ['Primo', 'Secondo']
